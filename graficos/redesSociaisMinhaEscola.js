...
function processarDados(dados) {
    ...
    incluirTexto(`Diferente dos dados fornecidos pela API dos dados sobre o mundo, os dados fornecidos pelas pesquisas na escola mostram que à uma grande divisão de foco entre o <span>Tik Tok</span>, <span>Instagram</span> e <span>Youtube</span>.`)
}
